...
def main():
    ...
    parser.add_argument("--platform", choices=["all", "topcv", "vietnamworks"], default="all", help="Nền tảng muốn chạy (mặc định: all)")
    ...
    if args.platform in ["all", "topcv"]:
        print("\n" + "#" * 60)
        print("🏢 [BƯỚC 1/2] XỬ LÝ PHÂN HỆ TOPCV")
        print("#" * 60)
    ...
    if args.platform in ["all", "vietnamworks"]:
        print("\n" + "#" * 60)
        print("🏢 [BƯỚC 2/2] XỬ LÝ PHÂN HỆ VIETNAMWORKS")
        print("#" * 60)
